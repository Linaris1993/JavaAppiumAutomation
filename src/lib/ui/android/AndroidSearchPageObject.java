...
public class AndroidSearchPageObject extends SearchPageObject {
    static {
        SEARCH_INIT_ELEMENT="xpath://lib.ui.android.widget.ImageView[@content-desc='Search Wikipedia']";
        SEARCH_INPUT="id:org.wikipedia:id/search_src_text";
        SEARCH_RESULT_BY_SUBSTRING_TPL="xpath://*[@text='{SUBSTRING}']";
        SEARCH_CANCEL_BTN="id:org.wikipedia:id/search_close_btn";
        SEARCH_RESULT_ELEMENT="xpath://*[@resource-id='org.wikipedia:id/search_results_list']//*[@class='lib.ui.android.view.ViewGroup']";
        ...
        SEARCH_INPUT_PLACEHOLDER="//*[@resource-id='org.wikipedia:id/search_container']//*[@class='lib.ui.android.widget.TextView']";
        }
